...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCadastrar.setText("Salvar Cliente");
...
public class Cadastro extends JFrame {
    ...
    private void initComponents() {
        ...
        // TÍTULO
        jLabel1 = new JLabel("CADASTRO DE CLIENTES", SwingConstants.CENTER);
        ...
        formPanel.add(criarCampo("Nome", txtNome));
        formPanel.add(criarCampo("Telefone", txtTelefone));
        formPanel.add(criarCampo("CPF", txtCpf));
        formPanel.add(criarCampo("Email", txtEmail));

        jPanel1.add(formPanel, BorderLayout.CENTER);

        // BOTÕES
        btnCadastrar = new JButton("Salvar Cliente");
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (clienteUtil.adicionar(cliente)) {
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao cadastrar cliente. CPF já pode estar cadastrado.",
                    "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
