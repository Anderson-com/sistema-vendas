...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCad.setText("Gerenciar Usuarios");
        ...
        btnReg.setText("Registrar Venda");
        ...
        btnDados.setText("Consultar Vendas");
    ...
    private void btnCadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadActionPerformed
        CadastroUser cadastro = new CadastroUser(this.tipoUsuario);
    ...
    private void btnDadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDadosActionPerformed
        Dados dados = new Dados(this.tipoUsuario);
